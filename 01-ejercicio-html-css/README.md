...
Hola genio! Como estas? Encontramos la rama `main-2` y nos trajimos todo el contenido + la corrección para esta rama de aquí. Luego para los siguientes, si puedes dejar el ejercicio en la rama `main`, nos ayudaría mucho :)

El ejercicio estuvo genial! Hubieron algunas mejoras a nivel de semántica que quisimos aplicar, junto con comentarios, para mejorarlo aún más. Luego si ves la PR, encontrarás lo que te comentamos en el propio código.

Hicimos cambios de CSS para mejorar el responsive, y también para acomodar estilos que se rompieron resultante de los cambios en el HTML que hicimos.
